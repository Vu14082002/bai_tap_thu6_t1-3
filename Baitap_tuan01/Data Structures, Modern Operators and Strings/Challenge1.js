...
// Dữ liệu về đội bóng và cầu thủ
const game = {
  team1: "Bayern Munich",
...
console.log(`Player team 1: ${players1}`);
console.log(`Player team 2: ${players2}`);
// 2
const [gk, ...fieldPlayers] = players1;
console.log(`GK team 1: ${gk}`);
console.log(`Other playe: ${fieldPlayers}`);
// 3
const allPlayers = [...players1, ...players2];
console.log(`All player 2 team: ${allPlayers}`);
// 4
...
const printGoals = function (...arr) {
  let text = arr.join(" ");
  console.log(`${text} :   ${arr.length} goals were  sroced`);
};
// printGoals("Davies", "Muller", "Lewandowski", "Kimmich");
printGoals(...game.scored);
//
game.team1 > game.team2 && console.log("Team 1 win");
game.team1 < game.team2 && console.log("Team 2 win");
